<!-- File: app/View/Home/service.php -->
<!-- ======= Services Section ======= -->
<section id="services" class="services">
    <div class="container">
        ...
        <div class="section-title">
            <h2>Services</h2>
            <p>Rakat Borneo Club menyediakan berbagai layanan untuk para anggota dan pecinta otomotif. Berikut adalah beberapa layanan yang kami tawarkan:</p>
        </div>
